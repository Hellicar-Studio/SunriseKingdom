...
public class MedaiPlayerSampleGUI : MonoBehaviour {
	...
	void OnGUI() {
		...
		if( GUI.Button(new Rect(100,50,100,100),"Load"))
		{
            scrMedia.Load("rtsp://88.97.57.25:10001/axis-media/media.amp?videocodec=h264");
			m_bFinish = false;
		}
...
//		}
		...
		if( GUI.Button(new Rect(250,50,100,100),"Unload"))
		{
			scrMedia.UnLoad();
		}
